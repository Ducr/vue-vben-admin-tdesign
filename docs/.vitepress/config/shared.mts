...
export const shared = defineConfig({
  ...
  themeConfig: {
    ...
    siteTitle: 'Vben Admin TDesign',
    socialLinks: [
      { icon: 'github', link: 'https://github.com/Ducr/vue-vben-admin-tdesign' },
    ],
  },
  title: 'Vben Admin TDesign',
  vite: {
    build: {
      ...
      alias: [
        {
          ...
          replacement: fileURLToPath(new URL('../../../internal/vite-config/src/index.ts', import.meta.url)),
        },
        {
    ...
    plugins: [
      GitChangelog({
        ...
        repoURL: () => 'https://github.com/Ducr/vue-vben-admin-tdesign',
      }),
      GitChangelogMarkdownSection(),
...
function pwa(): PwaOptions {
  return {
    ...
    manifest: {
      description:
        'Vben Admin TDesign is a TDesign Vue version SPA independently split from Vue Vben Admin v5.5.9. A modern admin dashboard template based on Vue 3.',
      icons: [
        {
          sizes: '192x192',
      ...
      id: '/',
      name: 'Vben Admin TDesign Doc',
      short_name: 'vben_admin_tdesign_doc',
      theme_color: '#ffffff',
    },
