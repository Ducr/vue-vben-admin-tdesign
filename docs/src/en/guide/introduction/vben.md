...
::: info You are reading the documentation for [Vben Admin TDesign](https://github.com/Ducr/vue-vben-admin-tdesign) version `5.5.9`! This is a TDesign Vue version SPA independently split from Vue Vben Admin v5.5.9.
...
- This project is based on [Vue Vben Admin](https://github.com/vbenjs/vue-vben-admin) v5.5.9, completely independently split, and can be deployed and released independently. Contributions are welcome to help maintain and improve the project, aiming to create a better mid- to backend solution.
